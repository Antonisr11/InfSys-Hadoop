...
<%
	...
	if (request.getParameter("next") != null) {
		...
		response.setHeader("Location", "http://localhost:8080/FirstWebApp/Stage2.jsp");
	}
%>
...
<body <%if (!enableNext) {%> onload="JavaScript:AutoRefresh(900);"
	...
	<div class="row mymenu">
		...
		<div class="col-2 d-flex justify-content-center align-items-center active">
		...
		<div class="row">
			...
			<div class="col-1 d-flex justify-content-center align-items-center">
				<button class="action-button" type="button"
					onclick='window.location.href = "http://localhost:8080/FirstWebApp/Stage3.jsp?next=1"'
